        ...
        .then((data) => {
          ...
          buttons.forEach(btn => {
            btn.addEventListener('click', (e) =>{
              const now = e.target;
              const txt = now.previousElementSibling;
              const tit = txt.previousElementSibling;
              //console.log(tit.textContent, txt.textContent);
              const message= `
              I have a question, I have a farm of potatoes. I diagnosed them and found that they have 
              ${sick}. One of the recommendations I have gotten is:\n
              `+tit.textContent+":\n"+txt.textContent+".\nWith clear explantions, can elaborate on that, what it is and how to do it?"
              window.location.href = "/agribot"// + encodeURIComponent(message);
            });
          })
